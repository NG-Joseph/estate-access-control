...
async function bootstrap() {
  ...
  */
  ...
  /**
   * Let's create static folders for public (css, images etc) Check https://www.google.com/search?q=what+are+static+files&oq=what+are+static+files&aqs=edge.0.0l7.3889j0j1&sourceid=chrome&ie=UTF-8
   */
  app.useStaticAssets({
