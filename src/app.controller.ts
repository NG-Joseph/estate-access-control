...
export class AppController {
  ...
  */
  ...
  home(@Res() reply: Reply){
    ...
    reply.view('guest-website/home.html', {apiVersion: API_VERSION!==null? `${API_VERSION}`: '', title: 'Estate Management System', homeActive: 'true', currentUrlSlug: API_VERSION!==null?`/${API_VERSION}`: '/'})
