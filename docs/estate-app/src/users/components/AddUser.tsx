                            ...
                            <div className="field is-horizontal">
                                ...
                                <div className="field-body">
                                    <div className="field">
                                        ...
                                        <div className="control">
                                            <input name="emailAddress" className="input" type="email" placeholder="Enter valid email here" maxLength={30} value={state.user.emailAddress} onChange={onChange} required />
                                        </div>
